            ...
            <div class="dropdown-box">
                <div class="products">
                    <div class="product product-cart">
                        ...
                        <figure class="product-media">
                            <a href="product-default.html">
                                <img src="{{ asset('assets/frontend/css/demo1.min.css') }}assets/images/cart/product-1.jpg" alt="product" height="84" width="94" />
                            </a>
                        </figure>
                    ...
                    <div class="product product-cart">
                        ...
                        <figure class="product-media">
                            <a href="product-default.html">
                                <img src="{{ asset('assets/frontend/css/demo1.min.css') }}assets/images/cart/product-2.jpg" alt="product" width="84" height="94" />
                            </a>
                        </figure>
                        <button class="btn btn-link btn-close" aria-label="button">
                            <i class="fas fa-times"></i>
