...
/*    public static function generateProductionToVendorRequisition( array $domain, int $id)
    {
    ...
    public static function generateProductionToVendorRequisition(array $domain, int $id): void
    {
        $invConfig = $domain['inv_config'];
