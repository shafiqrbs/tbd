...
class PurchaseReturnModel extends Model
{
    ...
    public static function getRecords($request, $domain)
    {
        ...
        if (isset($request['term']) && !empty($request['term'])) {
            $entities = $entities->whereAny(['inv_purchase_return.invoice', 'inv_purchase_return.sub_total', 'cor_vendors.name', 'cor_vendors.mobile', 'createdBy.username', 'acc_transaction_mode.name'], 'LIKE', '%' . $request['term'] . '%');
        }
