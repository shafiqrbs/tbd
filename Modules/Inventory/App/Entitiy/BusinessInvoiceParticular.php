...
class BusinessInvoiceParticular
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Appstore\Bundle\BusinessBundle\Entity\BusinessAndroidProcess")
     * @ORM\JoinColumn(onDelete="CASCADE")
     **/
    ...
    private $vendorStockItem;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="Appstore\Bundle\BusinessBundle\Entity\BusinessBatchParticular")
     **/
    private $batchItem;
