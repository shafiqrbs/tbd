 ...
 * BusinessParticular
 *
 * @ORM\Table( name = "business_particular_type")
...
class BusinessParticularType
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Appstore\Bundle\BusinessBundle\Entity\BusinessParticular", mappedBy="businessParticularType" )
     **/
