 ...
 * BusinessBatch
 *
 * @ORM\Table( name="business_batch")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\BusinessBundle\Repository\BusinessBatchRepository")
 */
class BusinessBatch
{
    /**
     ...
     * @ORM\OneToMany(targetEntity="Appstore\Bundle\BusinessBundle\Entity\BusinessBatchParticular", mappedBy="businessBatch")
     **/
