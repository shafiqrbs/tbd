 ...
 *
 * @ORM\Table( name = "business_batch_particular")
 * @ORM\Entity(repositoryClass="Appstore\Bundle\BusinessBundle\Repository\BusinessBatchParticularRepository")
 */
class BusinessBatchParticular
{
    ...
    /**
     * @var BusinessBatch
     * @ORM\ManyToOne(targetEntity="Appstore\Bundle\BusinessBundle\Entity\BusinessBatch", inversedBy="businessBatchParticulars")
