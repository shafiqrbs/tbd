...
class ReportController extends Controller
{
    ...
    public function summaryReport()
    {
        ...
        $cashSummary = AccountHeadModel::getAccountHeadLedgerSummary($configId);
    ...
    public function damageItemReport(Request $request)
    {
        ...
        $configId = $this->domain['inv_config'];
        $request = $request->all();
        $entities = ReportModel::damageItemReport($configId,$request);
        $service = new JsonRequestResponse();
        return $service->returnJosnResponse($entities);
    ...
    public function damageStockDetailsReport(Request $request)
    {
