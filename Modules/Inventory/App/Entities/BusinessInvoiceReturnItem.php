 ...
 * @ORM\Entity(repositoryClass="Modules\Inventory\App\Repositories\BusinessInvoiceReturnItemRepository")
 */
class BusinessInvoiceReturnItem
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Modules\Inventory\App\Entities\BusinessInvoice", inversedBy="invoiceReturnItems" )
     * @ORM\JoinColumn(onDelete="CASCADE")
     **/
    private  $invoice;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Modules\Inventory\App\Entities\BusinessInvoiceReturn", inversedBy="invoiceReturnItems" )
     * @ORM\JoinColumn(onDelete="CASCADE")
     **/
