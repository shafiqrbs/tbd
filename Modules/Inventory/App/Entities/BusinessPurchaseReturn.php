...
class BusinessPurchaseReturn
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Modules\Core\App\Entities\Vendor", inversedBy="businessPurchasesReturns" , cascade={"detach","merge"} )
     **/
    private  $vendor;

    /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessPurchaseReturnItem", mappedBy="businessPurchaseReturn")
     **/
