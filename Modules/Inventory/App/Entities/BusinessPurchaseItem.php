...
class BusinessPurchaseItem
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Modules\Inventory\App\Entities\BusinessPurchase", inversedBy="businessPurchaseItems" )
     * @ORM\JoinColumn(onDelete="CASCADE")
     **/
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Modules\Utility\App\Entities\ProductUnit", inversedBy="businessPurchaseItems" )
     **/
    private  $unit;
