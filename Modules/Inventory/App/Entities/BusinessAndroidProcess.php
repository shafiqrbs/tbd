 ...
 * @ORM\Entity(repositoryClass="Modules\Inventory\App\Repositories\BusinessAndroidProcessRepository")
 */
class BusinessAndroidProcess
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Modules\Inventory\App\Entities\BusinessConfig", inversedBy="androidProcess")
     */
