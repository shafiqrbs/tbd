 ...
 * @ORM\Entity(repositoryClass="Modules\Inventory\App\Repositories\BusinessStoreLedgerRepository")
 */
class BusinessStoreLedger
{
    ...
    protected $invoice;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="Modules\Inventory\App\Entities\BusinessStore", inversedBy="storeLedgers")
     **/
    protected $store;
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Modules\Utility\App\Entities\PaymentCard", inversedBy="businessInvoice" )
     **/
    private  $paymentCard;
