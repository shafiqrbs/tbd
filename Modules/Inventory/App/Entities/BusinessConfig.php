...
class BusinessConfig
{
    ...
    /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessInvoice", mappedBy="businessConfig")
     **/
    private $businessInvoices;

	 /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessStoreLedger", mappedBy="businessConfig")
     **/
    private $storeLedgers;

	 /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessAndroidProcess", mappedBy="businessConfig")
     **/
    private $androidProcess;

	/**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessReverse", mappedBy="businessConfig")
     **/
    private $businessReverses;


	/**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessBatch" , mappedBy="businessConfig")
     **/

    /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessVendorStock", mappedBy="businessConfig")
     **/
    private $businessVendorStocks;


    /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\Category", mappedBy="businessConfig")
     **/
    private $categories;


    /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\WearHouse", mappedBy="businessConfig")
     **/
    private $wearHouses;

    /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\Marketing", mappedBy="businessConfig")
     **/
    private $marketing;

     /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessArea", mappedBy="businessConfig")
     **/
    private $area;

     /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessPurchase", mappedBy="businessConfig")
     **/
    private $businessPurchases;

    /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessParticular", mappedBy="businessConfig")
     **/
    private $businessParticulars;

    /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessDamage", mappedBy="businessConfig")
     **/
    private $businessDamages;

    /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessPurchaseReturn", mappedBy="businessConfig")
     **/
