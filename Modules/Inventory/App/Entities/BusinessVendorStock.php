 ...
 * @ORM\Entity(repositoryClass="Modules\Inventory\App\Repositories\BusinessVendorStockRepository")
 */
class BusinessVendorStock
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Modules\Inventory\App\Entities\Config", inversedBy="businessVendorStocks" , cascade={"detach","merge"} )
    ...
    private  $businessConfig;
     ...
     /**
     * @ORM\ManyToOne(targetEntity="Modules\Core\App\Entities\Vendor", inversedBy="businessVendorStocks")
     **/
    private $vendor;


    /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessVendorStockItem", mappedBy="businessVendorStock", cascade={"remove"}))
     **/
