 ...
 * @ORM\Entity(repositoryClass="Modules\Inventory\App\Repositories\BusinessPurchaseRepository")
 */
class BusinessPurchase
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="Modules\Inventory\App\Entities\BusinessConfig", inversedBy="businessPurchases" , cascade={"detach","merge"} )
     **/
    private  $businessConfig;


    /**
     * @ORM\ManyToOne(targetEntity="Modules\Inventory\App\Entities\BusinessAndroidProcess", inversedBy="purchase" , cascade={"detach","merge"} )
     **/
    private  $androidProcess;


    /**
     * @ORM\OneToOne(targetEntity="Modules\Inventory\App\Entities\BusinessReverse", mappedBy="businessPurchase" , cascade={"remove"})
     **/
    private  $businessReverse;


    /**
     * @ORM\ManyToOne(targetEntity="Modules\Core\App\Entities\Vendor", inversedBy="businessPurchases" , cascade={"detach","merge"} )
     **/
    private  $vendor;
    ...
    /**
     * @ORM\OneToMany(targetEntity="Modules\Inventory\App\Entities\BusinessPurchaseItem", mappedBy="businessPurchase" , cascade={"remove"})
     * @ORM\OrderBy({"id" = "DESC"})
     **/
    private  $businessPurchaseItems;

    /**
     * @ORM\ManyToOne(targetEntity="Modules\Utility\App\Entities\TransactionMethod", inversedBy="businessPurchase" )
     **/
